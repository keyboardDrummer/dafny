...
namespace Microsoft.Dafny.V2
{
    ...
    class ForwardTransformer
    {
        ...
        value switch
        {
            Microsoft.Dafny.Lemma subType => throw new Exception("Deleted types should be removed by one of their containers"),
            Microsoft.Dafny.TwoStateLemma subType => throw new Exception("Deleted types should be removed by one of their containers"),
            Microsoft.Dafny.Constructor subType => Transform(subType),
            Microsoft.Dafny.PrefixLemma subType => throw new Exception("Deleted types should be removed by one of their containers"),
            Microsoft.Dafny.ExtremeLemma subType => throw new Exception("Deleted types should be removed by one of their containers"),
            _ => throw new Exception($"type {value.GetType()} not specified by unions.")
        };

        public virtual Microsoft.Dafny.ExtremeLemma TransformUnion(Microsoft.Dafny.ExtremeLemma value) =>
        value switch
        {
            Microsoft.Dafny.LeastLemma subType => throw new Exception("Deleted types should be removed by one of their containers"),
            Microsoft.Dafny.GreatestLemma subType => throw new Exception("Deleted types should be removed by one of their containers"),
            _ => throw new Exception($"type {value.GetType()} not specified by unions.")
        };
        ...
        public virtual Microsoft.Dafny.PrefixLemma Transform(Microsoft.Dafny.PrefixLemma value)
        {
            throw new NotImplementedException("Mutated types do not have a default Transform implementation.");
        }
